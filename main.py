...
def mainpage():
    ...
    if len(passwords) <= 1: 
        ...
        user_input = input("To add a new password type a, to exit type e:\n")
        checker(user_input)
        if user_input.lower() not in ['a', 'e']:
    ...
    user_input = input("To add a new password type a, to delete a password type d, to delete all paswords type da, to exit type e:\n")
    checker(user_input)
